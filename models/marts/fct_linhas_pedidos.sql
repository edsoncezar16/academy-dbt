...
cabecalho_pedido_com_sk as (
        ...
        LEFT JOIN cliente on cliente.ID_CLIENTE = scp.ID_CLIENTE
        LEFT JOIN cartao on cartao.ID_CARTAO = scp.ID_CARTAO
), 
...
detalhes_pedido_com_sk as (
        ...
        LEFT JOIN produto on produto.ID_PRODUTO = sdp.ID_PRODUTO
),
...
final as (
    ...
    LEFT JOIN cabecalho_pedido_com_sk on cabecalho_pedido_com_sk.ID_VENDA = detalhes_pedido_com_sk.ID_VENDA
)
